    ...
    return (
        <section id="events" className="events-categories world-red" style={{ paddingTop: '150px', minHeight: '100vh' }}>
            <div className="container">
                ...
                <div className="category-grid staggered-reveal">
                    {[
                        ...
                        <div key={i} className="category-card drifting-card" style={{ animationDelay: `${i * 0.1}s` }}>
                            <div className="cat-icon pulse-icon"><i className={`fas ${cat.icon}`}></i></div>
                            <div className="kanji-sub glow-text">{cat.kanji}</div>
                            <h3>{cat.title}</h3>
                            <p>{cat.desc}</p>
                            <span className="cat-link magic-underline">View Details</span>
                        </div>
                    ))}
                </div>
            </div>
